...
| [File structure & sidecar](file-structure.md) | The three shapes — inline, sidecar, pack — and when to use each |
...
| [CSVW (`#csvw`)](csvw.md) | Carry W3C CSVW metadata too, if you already have it |
